...
import {Button, Dialog, DialogContent, Tag} from '@macpaw/macpaw-ui';
                    ...
                    <div className={styles.employees}>
                        ...
                        {filterMembersAtCoordinates(selectedCoordinates, members).map((member) => (
                            <Fragment key={member.id}>
                                ...
                                <Button color='secondary' href={getSlackUrlByMember(member, teamId)} outline
                                        scale="small">Message in
                                    Slack</Button>
                            </Fragment>
                        ))}
                    </div>
...
export const getServerSideProps: GetServerSideProps = async (context) => {
    try {
        ...
        const members = await checkInMemberService.getAllCheckInNonNull();
