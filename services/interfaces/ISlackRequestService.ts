...
export interface ISlackRequestService {
    ...
    handleRenderAlertMainMenu(params: ActionHandlerParams<NonShortcutEvent>): Promise<void>;

    handleRenderCheckInSelfConfirmation(params: ActionHandlerParams<NonSlashCommandAction>): Promise<void>

    handleAlertConfirmation(params: ActionHandlerParams<NonSlashCommandAction>): Promise<void>
